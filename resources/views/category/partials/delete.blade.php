    ...
    <div class="flex min-h-screen items-center justify-center p-4 text-center sm:p-0">
        ...
        <div x-show="isDeleteModalOpen"
            ...
            <div class="p-6">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        <h3 class="text-lg font-bold text-slate-800 dark:text-slate-200" id="modal-title">Hapus Kategori</h3>
                        <div class="mt-2">
                            <p class="text-sm text-slate-500 dark:text-slate-400">
                                Apakah Anda yakin ingin menghapus kategori <span class="font-bold text-slate-700 dark:text-slate-300" x-text="deleteData.name"></span>? Tindakan ini tidak dapat dibatalkan.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-slate-50 dark:bg-slate-800/50 px-6 py-4 flex justify-end gap-3 rounded-b-2xl">
                ...
                <form method="POST" :action="'{{ url('kategori') }}/' + deleteData.id">
                    @csrf
                    @method('DELETE')
